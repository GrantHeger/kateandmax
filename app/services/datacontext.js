(function () {
    ...
    function datacontext(common) {
        ...
        function getHotels() {
            var hotels = [
                { hotel: "Courtyard", phone: '317-822-9029', address: '601 West Washington St., Indianapolis, IN', website: 'http://www.marriott.com/hotels/travel/indct-courtyard-indianapolis-downtown/' },
                { hotel: "Fairfield Inn", phone: '317-888-5535', address: '501 West Washington St., Indianapolis, IN', website: 'http://www.marriott.com/hotels/travel/indfd-fairfield-inn-and-suites-indianapolis-downtown/' },
            ];
            return $q.when(hotels);
        }
        function getTaxis() {
            var taxis = [
                { company: "AAA Hoosier Cab", phone: '317-888-8888' },
                { company: "Circle Center Cab", phone: '317-557-4132' },
                { company: "Yell-O Cab", phone: '317-908-2769' },
            ];
            return $q.when(taxis);
        }
    }
